...
class AdminDatatableController extends Controller
{
	...
	*/
	public function Participants($q)
	{
		...
		IFNULL((SELECT COUNT(id) FROM requirement_participants WHERE participant_id = participants.id GROUP BY requirement_participants.participant_id LIMIT 1),0) as requirements_count');
